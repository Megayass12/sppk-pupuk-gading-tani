...
<div class="sticky-top mb-3" style="top: 0; z-index: 100; background: #f8f9fa; border-bottom: 2px solid #0dcaf0; padding: 12px 0;">
    <div class="container-fluid px-md-5">
        <div class="row g-3 align-items-center">
            ...
            <div class="col-12 col-sm-3">
                <small class="text-muted d-block">Sisa Bobot</small>
                <div class="fw-bold text-success" style="font-size: 1.25rem;">{{ number_format($availableBobot * 100, 2) }}%</div>
            </div>
            <div class="col-12 col-sm-3">
                <small class="text-muted d-block">Bobot Ini</small>
                <div class="fw-bold text-warning" style="font-size: 1.25rem;">{{ number_format($bobot->bobot * 100, 2) }}%</div>
            </div>
            <div class="col-12 col-sm-3">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <input type="number" name="bobot" class="form-control @error('bobot') is-invalid @enderror"
                           value="{{ old('bobot', number_format($bobot->bobot * 100, 2, '.', '')) }}" step="0.01" min="0" max="100" placeholder="30" required>
